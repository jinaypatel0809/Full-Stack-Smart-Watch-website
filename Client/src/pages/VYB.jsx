    ...
    >
      ...
      >
        <img
          ...
          onError={(e) => { e.target.src = "https://placehold.co/300x210?text=VYB"; }}
        />
        {product.badge && (
...
export default function VYB() {
  const navigate = useNavigate();
  const { products: dbProducts, loading } = useProducts("vyb");
  ...
  return (
    <div className="min-h-screen bg-[#fafaf8]">
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg,#111 0%,#1f0a2e 60%,#2d0a1e 100%)" }}
      >
        ...
        <h1 className="text-white text-4xl font-black tracking-tight">VYB By Fastrack</h1>
        <p className="text-gray-400 text-sm mt-2">
          {loading ? "Loading collection..." : dbProducts.length === 0
            ? "No VYB products added yet"
            : `${filtered.length} bold styles for the fearless`}
        </p>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto px-5 py-7">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 px-5 py-4 mb-6 flex flex-wrap gap-3 items-center"
          ...
          <div className="relative flex-1 min-w-[180px]">
            ...
            <input type="text" placeholder="Search VYB products..." value={search}
        ...
        {loading && (
          <div className="flex items-center justify-center py-20 gap-3 text-gray-400">
            ...
            <span className="text-sm font-medium">Loading VYB products...</span>
          </div>
        )}
        ...
        {!loading && dbProducts.length === 0 && (
          <div className="text-center py-24">
            ...
            <p className="text-lg font-black text-gray-800 mb-2">No VYB products added yet</p>
            <p className="text-sm text-gray-400">Admin dashboard → "vyb" section maa products add karo.</p>
          </div>
        )}
        ...
        {!loading && filtered.length > 0 && (
          <p className="text-[13px] text-gray-400 mb-5">
            Showing <strong className="text-gray-800">{filtered.length}</strong> VYB products
          </p>
        )}
